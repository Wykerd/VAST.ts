...
export type Type = $.vast.Identity;

export function getDefaultValue(): $.vast.Identity {
  return {
    addr: undefined,
    pos: undefined,
    aoiRadius: 0,
...
export function createValue(partialValue: Partial<$.vast.Identity>): $.vast.Identity {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.vast.Identity): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.vast.Identity {
...
export function encodeBinary(value: $.vast.Identity): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.vast.Identity {
  const result = getDefaultValue();
